...
export const WorkflowSchema = z.object({
  ...
  techniques: WorkflowTechniquesSchema.optional().describe('LEGACY: Workflow-level primary technique ID. Prefer operations.'),
  operations: z.array(z.string()).optional().describe('Flat array of technique-id::operation-name (or technique-id::rule-name) references the workflow uses at the orchestrator level. Bundled into get_workflow responses alongside core orchestrator operations.'),
