...
Harness-specific invoke details for `harness_kind: cline`. Catalogue of alternate technique rules (`spawn` / `resume` / `concurrent`); standing wait policy; group contract is foreground-always.
