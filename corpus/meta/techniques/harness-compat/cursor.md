...
Harness-specific invoke details for `harness_kind: cursor`. Catalogue of alternate technique rules (`spawn` / `resume` / `concurrent`); standing wait/depth policy; group contract is foreground-always.
