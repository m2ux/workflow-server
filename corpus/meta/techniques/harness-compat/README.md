...
| [`resolve-harness-operation`](resolve-harness-operation.md) | Resolve harness kind plus a technique kind to the harness-specific technique file and rule slice |
