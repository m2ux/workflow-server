...
Techniques in this library are bound by the meta activities and are also referenced from other workflows, which qualify them by group (`workflow-engine::dispatch-activity`, `harness-compat::spawn-agent`). A reference from outside meta is always written qualified.
