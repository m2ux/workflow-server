...
The criteria a workflow definition is authored toward and audited against. The canon belongs to no single workflow and to every workflow that reaches it, which is what puts it at the corpus root rather than inside a product.
