...
- Use [gitnexus](/gitnexus/techniques/TECHNIQUE.md)::[context](/gitnexus/techniques/context.md)(*name*: `{finding_symbol}`, *repo_name*: `{repo_name}`) to determine which execution flows it participates in — this adds process context to the finding location.
