...
Name every piece of mutable context in this system that more than one technique consumes or modifies. For each: who changes it, who reads it, and what assumption the reader makes about its contents that is never verified.
