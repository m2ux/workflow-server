---
name: blindspot
description: Meta-blindspot prism — analyzes what the entire prism catalog systematically misses. Not a structural analysis of code, but a structural analysis of the ANALYTICAL FRAMEWORK itself. Run periodically to discover new prism needs. Feed it the catalog (prism names + descriptions) or any analytical output.
metadata:
  order: 52
  legacy_id: 52
  ...
  steps: 4
  words: 195
  origin: "Round 42 — fills epistemic gap: no prism audited the catalog itself"
---
...
Name the trade-off that governs what the catalog can and cannot see: A × B = constant. What does the entire analytical framework ALWAYS find, and what does it ALWAYS miss — regardless of which prism is used?
