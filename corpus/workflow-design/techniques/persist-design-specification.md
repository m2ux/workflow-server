...
- Include only facts this artifact homes per canonical-home-map and the sections it carries, [Template](../resources/design-specification.md#template) and [Rules](../resources/design-specification.md#rules) — purpose and dimension deltas
