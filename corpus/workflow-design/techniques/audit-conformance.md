...
- Survey similar-type reference workflows via [list-workflows](/meta/techniques/workflow-engine/list-workflows.md) (orchestrator-supplied definitions — orchestrator-conduct.no-domain-work)
