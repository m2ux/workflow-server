...
- When `{operation_type}` is `update` or `review`, load targets via [list-workflows](/meta/techniques/workflow-engine/list-workflows.md) from orchestrator-supplied definitions (orchestrator-conduct.no-domain-work)
