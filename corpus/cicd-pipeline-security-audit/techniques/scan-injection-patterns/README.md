...
| [`scan-p3`](scan-p3.md) | Apply P3 comment trigger abuse detection: flag `issue_comment` and `pull_request_review_comment` workflows that execute privileged techniques without author-association filtering |
