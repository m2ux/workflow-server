...
- `{review_summary}` arrives as confirmed bytes; post it verbatim — never re-render, paraphrase, strip hyperlinks, or collapse the consolidated format into a free-form comment.
