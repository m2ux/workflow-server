...
|---|---|
| [`challenge`](challenge.md) | Adversarial challenge perspectives over the current concern set for the combine step |
| [`combine`](combine.md) | Challenge findings folded into the concern set, with the convergence and residue flags that fold implies |
