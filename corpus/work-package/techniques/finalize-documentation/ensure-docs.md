...
5. Verify the documentation builds — on Rust/Substrate through [cargo](/cargo/techniques/TECHNIQUE.md)::[doc](/cargo/techniques/doc.md)(*scope*=`--workspace --no-deps`), on other project types through that project's equivalent doc command.
