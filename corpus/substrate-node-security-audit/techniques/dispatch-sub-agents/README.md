...
| [`verify-output-files`](verify-output-files.md) | Confirm every expected per-agent output file persisted into the planning folder, re-dispatching the owning agent for any missing file |
