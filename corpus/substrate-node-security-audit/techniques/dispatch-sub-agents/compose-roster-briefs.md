...
- Do not dispatch agents from this technique — the binding activity binds [orchestration-patterns](/meta/techniques/orchestration-patterns/TECHNIQUE.md)::[dispatch-workers](/meta/techniques/orchestration-patterns/dispatch-workers.md) next.
