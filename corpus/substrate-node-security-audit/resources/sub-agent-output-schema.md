---
name: sub-agent-output-schema
description: All sub-agents dispatched during the primary-audit phase must return their results in this structured format.
metadata:
  order: 4
  legacy_id: 4
---
...
The `§3.X` keys in the `checklist_coverage` object below are the manual-review checklist identifiers indexed in [audit-template-reference](./audit-template-reference.md).
