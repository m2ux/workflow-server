...
Every technique inherits the shared contract in [`TECHNIQUE.md`](./TECHNIQUE.md), and carries a `plain-language::technique` address another workflow can bind without copying the file — the embedded-check use.
...
|-----------|------------|
| [`intake-and-profile`](./intake-and-profile.md) | Classify the technique and settle the reader profile and content selection |
