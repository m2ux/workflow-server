...
alike. For a markdown source, the section is the nearest heading above the passage — the fragment
[source-reference format](./specification-protocol.md#source-reference-format) puts on the requirement's
source link. What counts as a normative obligation, and what makes a row a coverage gap, are defined in
