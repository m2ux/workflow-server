...
- Use [gitnexus](/gitnexus/techniques/TECHNIQUE.md)::[query](/gitnexus/techniques/query.md) for concept-driven flow discovery and [gitnexus](/gitnexus/techniques/TECHNIQUE.md)::[context](/gitnexus/techniques/context.md) for symbol-level caller/callee inspection when the codebase is indexed; otherwise read the code paths directly.
