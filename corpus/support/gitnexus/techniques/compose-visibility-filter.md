...
4. Cover every label the changed set spans: a method, a class and a struct each sit under their own label, so a query naming one returns the exported surface of that label alone.
