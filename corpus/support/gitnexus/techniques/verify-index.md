...
2. Carry `{index_stale}` as the age of every answer taken from this graph afterwards. The `index-refresh` run is this read with the rebuild that clears it attached.
