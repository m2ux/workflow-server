...
The graph holds the call sites the parser reads in source, among the symbols the indexed tree defines. Three kinds of dependency are therefore absent from a fresh index as much as a stale one, and all are common:
