...
| [`group-radius`](group-radius.yaml) | How far a concern in one member reaches into every other, each answer naming its graph and the instrument that settled it |
