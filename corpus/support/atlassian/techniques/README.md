...
| [`list-jira-issue-fields`](list-jira-issue-fields.md) | Discover the fields for a specific issue type in a project |
...
| [`resolve-cloud-id`](resolve-cloud-id.md) | Obtain the Atlassian cloud id for the target site |
