...
Target-specific calibration examples are in **[target-profile](./target-profile.md) (target-profile)**. Load the target profile during scope-setup and use its severity benchmark table as calibration anchors. If your scoring diverges by 2+ levels from the benchmark, re-evaluate.
