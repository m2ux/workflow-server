...
description: Every finding MUST be scored on both dimensions.
metadata:
  order: 2
  legacy_id: 2
---
...
Target-specific calibration examples are in **[target-profile](../../resources/target-profile/SKILL.md) (target-profile)**. Load the target profile during scope-setup and use its severity benchmark table as calibration anchors. If your scoring diverges by 2+ levels from the benchmark, re-evaluate.
