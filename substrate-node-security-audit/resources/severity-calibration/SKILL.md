...
description: "Use with resource 02 (severity rubric): for scoring."
metadata:
  order: 8
  legacy_id: 8
---
...
Use with **[severity-rubric](../../resources/severity-rubric/SKILL.md) (severity rubric)** for scoring. This resource provides the full Impact/Feasibility scales, severity mapping, calibration examples, crosscheck procedure, and bias correction.
