...
Use with **[severity-rubric](./severity-rubric.md) (severity rubric)** for scoring. This resource provides the full Impact/Feasibility scales, severity mapping, calibration examples, crosscheck procedure, and bias correction.
