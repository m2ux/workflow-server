...
description: "The audit prompt template is located at:"
metadata:
  order: 1
  legacy_id: 1
---
...
9. **Group B mechanical verification** — static analysis agent runs historically-missed pattern searches (impl Ord completeness, take_while truncation, buffer preallocation, RPC fan-out, StorageInit consistency) via [static-analysis-patterns](../../resources/static-analysis-patterns/SKILL.md)
...
- Mechanical verification of historically-missed patterns (Group B via [static-analysis-patterns](../../resources/static-analysis-patterns/SKILL.md))
