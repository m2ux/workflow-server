 ...
 *
 * Usage:
 *   npx tsx guards/check-stealth-isolation.ts [--workflow remediate-vuln] [--root <workflows-dir>]
 *   npx tsx guards/check-stealth-isolation.ts --target /path/to/private/checkout [--remote security]
 *
