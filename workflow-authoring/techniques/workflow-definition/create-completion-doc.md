...
What the operator decided about the brief's open judgements — `settled` where each took the position the brief argued for, `carried-open` where they reach close-out unresolved. Empty when the brief left none open.
