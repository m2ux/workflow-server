...
Monorepo reference submodules refreshed to tracked remote HEADs, with locking and skip-if-recent coordination.

## Inputs

### reference_path

Path to the reference checkout (the engineering / parent monorepo whose submodules are refreshed).

## Outputs

### refreshed_submodules

The reference's submodules advanced to their tracked branches' remote HEADs, or unchanged when the refresh was skipped or gated out.
