...
- Assess complexity as simple, moderate, or complex: simple = clear problem with a known solution or existing pattern (minor fixes completable in <30 minutes); moderate = some uncertainty in approach; complex = architectural decisions, multiple viable approaches, trade-offs or contradictions between requirements, an unfamiliar problem or domain, or performance/reliability/scalability requirements.
