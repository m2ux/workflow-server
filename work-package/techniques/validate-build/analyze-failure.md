...
1. Parse the {diagnostics} for the failed `check-id` and classify into {\$failure_class}. Compile and test failures cite a file:line — resolve that location against `target-path` and read it via the harness Read tool.
