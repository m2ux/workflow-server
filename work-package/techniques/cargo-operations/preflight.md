...
3. Return missing_prerequisites. Do NOT attempt installation — environment changes always require user consent. If any required toolchain component is unresolved, surface it to the user as an environment finding via the activity's validate action rather than auto-installing.
