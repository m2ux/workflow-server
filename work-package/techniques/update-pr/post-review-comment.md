...
1. `{review_summary}` is confirmed by the user at the `review-summary-approval` checkpoint before this technique runs; post it verbatim — never re-render or paraphrase it.
