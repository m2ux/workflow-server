...
2. Read the fan-out and affected-process count as the {complexity-signal}: high fan-out or many affected processes indicate higher complexity than the issue text alone might suggest.
