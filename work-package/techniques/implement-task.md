...
- Read the resulting `impact_report`; where it reports HIGH or CRITICAL risk, surface that level and the symbols it names before editing, and record them in `{task_implementation}`
