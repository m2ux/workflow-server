...
| 02 | `readme-deprecated` | README Guide (deprecated) | **Deprecated** — consolidated into `01-readme.md` as of v2.0.0; retained as a redirect stub. New planning-folder work uses `id: readme` (resource 01). |
