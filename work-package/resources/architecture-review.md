...
Superseded by `ADR: New Decision`
```
...
- `ADR: Related Decision 1` - [Brief explanation of relationship]
- `ADR: Related Decision 2` - [Brief explanation of relationship]
```
