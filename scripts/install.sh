...
if [[ -d "${INSTALL_DIR}/examples/cursor-workspace" ]]; then
  echo "Removing ${INSTALL_DIR}/examples/cursor-workspace"
  rm -rf "${INSTALL_DIR}/examples/cursor-workspace"
fi
