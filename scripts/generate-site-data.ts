...
export const SITE_ROUTES: SiteRoute[] = [
  ...
  { relPath: 'guide/workflow-architecture.html', section: 'guide', title: 'Workflow architecture', navLabel: 'Workflow architecture', sequence: 4 },
  { relPath: 'guide/running-workflows.html', section: 'guide', title: 'Running workflows', navLabel: 'Running workflows', sequence: 5 },
