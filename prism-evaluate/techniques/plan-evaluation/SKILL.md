...
Directory to write the evaluation plan artifact
...
- If no dimensions supplied, use attached [default-dimensions](../../resources/default-dimensions/SKILL.md) (default-dimensions) and select the dimension set matching the target_type. Each dimension object has: { name, description, focus_areas (array of specific aspects to examine) }.
...
- Use attached [dimension-lens-mapping](../../resources/dimension-lens-mapping/SKILL.md) (dimension-lens-mapping) for the standard and custom mapping tables, output subdirectory conventions, and pipeline mode selection guidance.
...
- Assign each dimension an output_subdir per the conventions in [dimension-lens-mapping](../../resources/dimension-lens-mapping/SKILL.md).
