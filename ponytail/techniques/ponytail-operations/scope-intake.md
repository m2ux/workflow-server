...
- Write the `{lean_brief}`: task, target, intensity, scope, the traced flow, the reachable [rungs](../../resources/the-ladder.md#rungs), and the safety-floor obligations in play.
