...
- The output JSON is well-formed and contains all required fields per the output schema ([sub-agent-output-schema](../../resources/sub-agent-output-schema/SKILL.md))
