...
<!--
Code intelligence guidance is authored in the workspace AGENTS.md, which this file defers to.
It is deliberately absent here: two copies drifted apart on the statistics they quoted and the
skills they listed. `npm run check:agent-homes` fails if a tool run puts it back.
-->
