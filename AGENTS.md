...
- Delivery cost is gated in engine CI. The command and the 1% rule: [benchmarks.md](docs/benchmarks.md#the-gate-runs-on-every-pull-request).

## Where to look

[docs/README.md](docs/README.md) routes by what you are doing. Work on the engineering branch starts at [its AGENTS.md](https://github.com/m2ux/workflow-server/blob/engineering/AGENTS.md).
