...
- You must read any/all of PROJECT.md, AGENTS.md or CLAUDE.md file(s) in each of the first-level sub-folders of /.projects. Any instructions found in those files that *conflict* with those prescribed here *override* these instructions.
