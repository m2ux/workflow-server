...
The markdown files in the repository (`README.md`, `docs/setup.md`, `docs/http.md`, `docs/stdio.md`, `docs/`, `schemas/README.md`) are the **canonical documentation source** for editing. The HTML site is the **browsable view** for reading: shorter prose, diagrams, and direct links to every page.
