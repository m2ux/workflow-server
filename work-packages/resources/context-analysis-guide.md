---
name: context-analysis-guide
description: "Use context analysis when the user indicates this is a new initiative: — no existing planning documents or prior work on this set of packages."
metadata:
  version: 1.0.0
  order: 2
  legacy_id: 2
