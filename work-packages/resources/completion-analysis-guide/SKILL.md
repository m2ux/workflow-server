---
name: completion-analysis-guide
description: "Use completion analysis when the user indicates this is continuing previous work: — there are existing planning documents, partial implementations, or prior roadmap artifacts."
metadata:
  version: 1.0.0
  order: 1
  legacy_id: 1
