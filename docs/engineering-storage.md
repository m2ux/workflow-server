...
3. `init-repo.sh owner/repo` registers the app so sessions resolve planning under `$HOST_PROJECTS_ROOT/<repo>/.engineering/` (see [install-projects-worktrees.md](install-projects-worktrees.md)).
