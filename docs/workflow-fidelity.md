...
For each session the server maintains two files under the planning folder (under the **engineering root** — see [State Management](state_management_model.md#5-persistence)):
