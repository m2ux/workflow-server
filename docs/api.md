...
Schema documents, fetched by URI. The field guide is the [schema](../schemas/README.md).

| Resource | Purpose | Detail |
| -------- | ------- | ------ |
| [workflow-server://schemas](../src/resources/schema-resources.ts#L47) | Every schema, in one document | [Schema guide](../schemas/README.md) |
...
| [get_workflow_status](../src/tools/workflow-tools.ts#L2965) | Where the session stands                              | { [session_index](../src/utils/session/params.ts#L10) } | [status](../src/tools/workflow-tools.ts#L3007), [in_flight](../src/tools/workflow-tools.ts#L3012), [completed_activities](../src/tools/workflow-tools.ts#L3013), [variables](../src/tools/workflow-tools.ts#L3016), [workflow](../src/tools/workflow-tools.ts#L3017), [last_checkpoint](../src/tools/workflow-tools.ts#L3025)? | [Polling](dispatch.md#polling-a-dispatched-workflow)               |
| [inspect_session](../src/tools/workflow-tools.ts#L3040) | Read session state. A checkpoint does not block it { [session_index](../src/utils/session/params.ts#L10) } ∪ { [view](../src/tools/workflow-tools.ts#L3044)?, [child_index](../src/tools/workflow-tools.ts#L3046)?, [variable](../src/tools/workflow-tools.ts#L3048)?, [agent_id](../src/tools/workflow-tools.ts#L3050)? } | The [projection](../src/tools/workflow-tools.ts#L3064) named by view | [Persistence](state.md#persistence)                     |
...
| Tool                 | Purpose                                                                     | Parameters                                                                 | Returns                                                                             | Detail                                                                                      |
| -------------------- | -------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| [get_workflow](../src/tools/workflow-tools.ts#L804) | Load the session workflow | { [session_index](../src/utils/session/params.ts#L10) } | { technique bundle } ∪ { [id](../src/tools/workflow-tools.ts#L832), [version](../src/tools/workflow-tools.ts#L833), [title](../src/tools/workflow-tools.ts#L834), [description](../src/tools/workflow-tools.ts#L835), [rules](../src/tools/workflow-tools.ts#L836)?, [variables](../src/tools/workflow-tools.ts#L841)?, [initialActivity](../src/tools/workflow-tools.ts#L842), [graph](../src/tools/workflow-tools.ts#L845), [activities](../src/tools/workflow-tools.ts#L846), [activity_load_errors](../src/tools/workflow-tools.ts#L850)?, [session_index](../src/tools/workflow-tools.ts#L851), [planning_folder_path](../src/tools/workflow-tools.ts#L857) } | [Orchestrator bundle](delivery.md#the-orchestrator-bundle)                            |
| [next_activity](../src/tools/workflow-tools.ts#L1186) | Advance to the next activity. The body stays with get_activity { [session_index](../src/utils/session/params.ts#L10), [activity_id](../src/tools/workflow-tools.ts#L1189) } ∪ { [from_activity](../src/tools/workflow-tools.ts#L1192)?, [exit](../src/tools/workflow-tools.ts#L1195)?, [step_manifest](../src/tools/workflow-tools.ts#L1196)?, [activity_manifest](../src/tools/workflow-tools.ts#L1197)?, [variables_changed](../src/tools/workflow-tools.ts#L1198)?, [artifacts_produced](../src/tools/workflow-tools.ts#L1199)?, [agent_id](../src/tools/workflow-tools.ts#L1200)?, [context_tokens](../src/tools/workflow-tools.ts#L1203)?, [progress_published](../src/tools/workflow-tools.ts#L1206)? } | { [activity_id](../src/tools/workflow-tools.ts#L1644), [session_index](../src/tools/workflow-tools.ts#L1648) } ∪ { [name](../src/tools/workflow-tools.ts#L1647) ⊕ [outstanding](../src/tools/workflow-tools.ts#L1646) } ∪ { [trace_token](../src/tools/workflow-tools.ts#L1626)? } | [Choosing the next activity](state.md#choosing-the-next-activity)          |
| [get_activity](../src/tools/workflow-tools.ts#L1657) | Load the activity this context was dispatched for { [session_index](../src/utils/session/params.ts#L10), [context_tokens](../src/utils/session/params.ts#L29) } ∪ { [agent_id](../src/utils/session/params.ts#L49)?, [activity_id](../src/tools/workflow-tools.ts#L1670)?, [bundle](../src/tools/workflow-tools.ts#L1673)? } | { activity body, [exit_destinations](../src/tools/workflow-tools.ts#L2321), [batch](../src/tools/workflow-tools.ts#L2313) } ∪ { [dispatch](../src/tools/workflow-tools.ts#L2320), [batch](../src/tools/workflow-tools.ts#L2320), [artifact_prefix](../src/tools/workflow-tools.ts#L2319), [artifacts](../src/tools/workflow-tools.ts#L2319), [exit_destinations](../src/tools/workflow-tools.ts#L2321)?, [fan_instance](../src/tools/workflow-tools.ts#L2322)? } | [Worker bundle](delivery.md#the-worker-bundle)                                        |
| [yield_checkpoint](../src/tools/workflow-tools.ts#L2379) | Yield a checkpoint, or replay one already answered { [session_index](../src/utils/session/params.ts#L10), [checkpoint_id](../src/tools/workflow-tools.ts#L2382) } ∪ { [message](../src/tools/workflow-tools.ts#L2383)?, [options](../src/tools/workflow-tools.ts#L2384)?, [variables_changed](../src/tools/workflow-tools.ts#L2389)? } | { [status](../src/tools/workflow-tools.ts#L2530), [checkpoint_id](../src/tools/workflow-tools.ts#L2531), [session_index](../src/tools/workflow-tools.ts#L2532), [variables_published](../src/tools/workflow-tools.ts#L2533)? } ⊕ { [status](../src/tools/workflow-tools.ts#L2485), [checkpoint_id](../src/tools/workflow-tools.ts#L2486), [session_index](../src/tools/workflow-tools.ts#L2487), [resolved_option](../src/tools/workflow-tools.ts#L2488), [effect](../src/tools/workflow-tools.ts#L2491)? } | [The worker pauses](checkpoint.md#the-worker-pauses)                                  |
| [resume_checkpoint](../src/tools/workflow-tools.ts#L2602) | Continue after the checkpoint is resolved                                   | { [session_index](../src/utils/session/params.ts#L10) } | [status](../src/tools/workflow-tools.ts#L2632), [session_index](../src/tools/workflow-tools.ts#L2633), [checkpoint](../src/tools/workflow-tools.ts#L2634), [option_id](../src/tools/workflow-tools.ts#L2635), [variables_changed](../src/tools/workflow-tools.ts#L2636) | [Resume protocol](checkpoint.md#the-resume-protocol)                                  |
| [present_checkpoint](../src/tools/workflow-tools.ts#L2645) | Load the active checkpoint for the user                                     | { [session_index](../src/utils/session/params.ts#L10) } | { [message](../src/tools/workflow-tools.ts#L2677), [options](../src/tools/workflow-tools.ts#L2686), [session_index](../src/tools/workflow-tools.ts#L2712) } | [Presenting and resolving](checkpoint.md#the-user-facing-agent-presents-and-resolves) |
| [respond_checkpoint](../src/tools/workflow-tools.ts#L2719) | Clear the active checkpoint                                                 | { [session_index](../src/utils/session/params.ts#L10) } ∪ { [option_id](../src/tools/workflow-tools.ts#L2724) ⊕ [auto_advance](../src/tools/workflow-tools.ts#L2725) ⊕ [condition_not_met](../src/tools/workflow-tools.ts#L2726) } | { [checkpoint_id](../src/tools/workflow-tools.ts#L2870), [resolved](../src/tools/workflow-tools.ts#L2871), [session_index](../src/tools/workflow-tools.ts#L2872) } ∪ { [resolved_option](../src/tools/workflow-tools.ts#L2874)?, [effect](../src/tools/workflow-tools.ts#L2875)?, [dismissed](../src/tools/workflow-tools.ts#L2876)?, [exit](../src/tools/workflow-tools.ts#L2882)? } | [Three ways to resolve one](checkpoint.md#three-ways-to-resolve-one)                  |
...
| Tool            | Purpose                                                       | Parameters                                                                                    | Returns                                      | Detail                                                                                  |
| --------------- | --------------------------------------------------------------------------------------------- | -------------------------------------------- | ------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| [get_technique](../src/tools/resource-tools.ts#L796) | Load one technique on demand                                  { [session_index](../src/utils/session/params.ts#L10) } ∪ { [technique_id](../src/tools/resource-tools.ts#L804)?, [step_id](../src/tools/resource-tools.ts#L807)?, [activity_id](../src/tools/resource-tools.ts#L808)?, [agent_id](../src/utils/session/params.ts#L49)?, [bundle](../src/tools/resource-tools.ts#L809)?, [full](../src/tools/resource-tools.ts#L810)? } | { [composed technique](../src/tools/resource-tools.ts#L1055) } ⊕ { [unchanged marker](../src/tools/resource-tools.ts#L1017) } | [Asking for one by name](delivery.md#asking-for-one-by-name)                      |
