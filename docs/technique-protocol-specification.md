...
`parseTechniqueRef` ([technique-ref.ts](https://github.com/m2ux/workflow-server/blob/main/src/loaders/technique-ref.ts)) is the one
...
[the anti-pattern catalog](../corpus/canon/resources/anti-patterns.md).
