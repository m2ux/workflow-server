...
The anti-pattern this page derives from is AP-60, in the [anti-pattern catalog](https://github.com/m2ux/workflow-server/blob/workflows/corpus/canon/resources/anti-patterns.md) on the `workflows` branch, which carries the full authoring set.
