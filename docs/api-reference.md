...
- **Warn-only (`_meta.validation`):** transition legality, `initialActivity`-first, `transition_condition` text match, step and activity manifests, version drift.
