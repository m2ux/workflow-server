...
- **Workflow-authoring contracts** → the [document corpus](https://github.com/m2ux/workflow-server/blob/workflows/docs/README.md). A page that is about one of those documents links the name in the sentence. The [schema guide](schemas.md) stays on this tree, generated from the Zod sources.
