...
Host layout is created by [`scripts/install.sh`](../scripts/install.sh); product checkouts under `HOST_PROJECTS_ROOT` are managed by you (see [setup.md](../setup.md)). `init-repo.sh` is deprecated.
