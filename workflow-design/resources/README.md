...
Supplementary guide for review mode. The audit procedure itself is canonical in the `workflow-design` technique protocol (steps prefixed with `audit-`); this resource carries only the material that doesn't fit naturally as protocol bullets:
