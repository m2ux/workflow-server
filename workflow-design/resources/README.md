...
| `02` | [Anti-Patterns](02-anti-patterns.md) | 31 prohibited patterns organized by category: structural, interaction, schema, rule hygiene, description hygiene, execution | [Quality Review](../activities/README.md#08-quality-review) (anti-pattern scan), review mode (compliance audit) |
...
31 prohibited patterns organized into six categories:
...
| Description hygiene | 2 | Rationale/process narration in description fields, justification tails on validate messages |
