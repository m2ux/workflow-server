...
- [design-principles](../../resources/design-principles/SKILL.md) — design principles (input for `audit-principle-compliance`)
- [schema-construct-inventory](../../resources/schema-construct-inventory/SKILL.md) — schema construct inventory (input for `audit-expressiveness`)
- [anti-patterns](../../resources/anti-patterns/SKILL.md) — anti-pattern catalog (input for `audit-anti-pattern-scan` and `audit-rule-hygiene`)
