...
Validate every TOON file in a workflow against its JSON schema and confirm every reference resolves through the loader, recording per-file pass/fail with the validator's message and resolving failures before proceeding.
