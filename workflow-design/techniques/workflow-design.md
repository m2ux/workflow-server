...
- Walk every anti-pattern in [anti-patterns](../resources/anti-patterns.md) (currently 52 entries across 8 categories); for each finding, record file, content, and recommended fix
