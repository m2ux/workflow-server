...
- Refresh the catalog via [list-workflows](../../meta/techniques/workflow-engine/list-workflows.md) and survey 2+ similar-type workflows from orchestrator-supplied definitions ([orchestrator-no-domain-work](../../meta/techniques/orchestrator-conduct.md#orchestrator-no-domain-work) — workers do not load full workflow definitions)
