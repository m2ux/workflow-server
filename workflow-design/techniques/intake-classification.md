...
- When `{operation_type}` is `update` or `review`, load targets via [list-workflows](../../meta/techniques/workflow-engine/list-workflows.md) from orchestrator-supplied definitions ([orchestrator-no-domain-work](../../meta/techniques/orchestrator-conduct.md#orchestrator-no-domain-work))
