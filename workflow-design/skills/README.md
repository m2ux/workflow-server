...
> The universal skills `meta-orchestrator`, `workflow-orchestrator`, and `activity-worker` from [meta/skills/](../../meta/skills/) apply to this workflow's orchestration model.
