...
4. Call `get_skill(session_token: <session_token>)` to load the workflow's primary skill. This is the orchestrator skill — it tells you how to coordinate the workflow. Do NOT skip this step. Do NOT call next_activity or get_activity before loading the orchestrator skill.
