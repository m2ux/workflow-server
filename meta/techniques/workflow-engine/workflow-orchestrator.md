...
- On `batch_may_continue: true`, apply [continue-batch](./continue-batch.md) to advance that same worker onto the routed activity; otherwise release its identity and dispatch afresh
