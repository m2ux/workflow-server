...
1. `nice -n 19 SKIP_WASM_BUILD=1 CARGO_BUILD_JOBS=${CARGO_BUILD_JOBS:-4} cargo check {scope} {features}`; compose `{check_status}` = `{ check_id: 'check', passed: <exit code 0>, diagnostics: <rustc output> }`.
