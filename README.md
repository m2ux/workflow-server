...
> This project targets an agent-human pair-programming (rather than fully autonomous/vibe-coding) use case. At present it uses a single agent per workflow. Multi-agent orchestration is TBA.
---
