...
This project is indexed by GitNexus as **workflow-server** (10264 symbols, 13634 relationships, 260 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
