...
- Always apply at least two lenses. A single portfolio lens should use the structural-analysis technique instead.
...
**Recovery:** Use the structural-analysis technique for single-lens analysis, or add a complementary lens per the selection guide
