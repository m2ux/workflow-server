...
- Dispatch deep_scan ([deep-scan](../../resources/deep-scan/SKILL.md)) to a fresh worker on Haiku
...
- Dispatch L12 ([l12](../../resources/l12/SKILL.md)) to a fresh worker on Sonnet
