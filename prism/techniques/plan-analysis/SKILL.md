...
- For units assigned full-prism: no lens selection needed — the pipeline uses the L12 set (00-02) for all target types
...
- [behavioral-synthesis](../../resources/behavioral-synthesis/SKILL.md)
- [writer-critique](../../resources/writer-critique/SKILL.md)
- [writer-synthesis](../../resources/writer-synthesis/SKILL.md)
