...
Literacy surface for updating `workflow-design` planning-artifact guidance. Grounded in schema docs, `convention-conformance`, and live YAML from `workflow-design` / `work-package`.
