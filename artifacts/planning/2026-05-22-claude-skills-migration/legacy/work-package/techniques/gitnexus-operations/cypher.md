...
- Reserve this for custom call-chain traces, ordering/error-path assertions, and visibility filters; prefer [impact](impact.md) / [context](context.md) / [query](query.md) when they suffice.
