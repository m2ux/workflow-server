...
- Use attached [readme](../../resources/readme/SKILL.md) for the README.md template and guidelines
...
**Description:** Verify the planning folder's README.md still matches the [readme](../../resources/readme/SKILL.md) template structure (header block, executive summary, problem/solution overview, progress table, links). Catches template drift that would otherwise only be flagged late in the workflow by a human reviewer.
...
- Read {planning_folder_path}/README.md and load [readme](../../resources/readme/SKILL.md) (the README template) via get_resource.
...
- **readme_missing** — Cause: No README.md found in planning_folder_path · Recovery: Re-run the [create-readme](#2-create-readme) protocol to seed the README from [readme](../../resources/readme/SKILL.md) before continuing
