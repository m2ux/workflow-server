...
2. Compose the PR body using the Initial template from [pr-description](../../resources/pr-description/SKILL.md). Reference `issue_number` in the PR title and body.
