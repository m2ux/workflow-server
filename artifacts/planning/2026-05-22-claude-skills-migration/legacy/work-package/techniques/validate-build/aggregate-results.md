...
- **build_status** — Pass/fail captured from [cargo-operations](../cargo-operations/SKILL.md)::[check](../cargo-operations/check.md) or [cargo-operations](../cargo-operations/SKILL.md)::[build-release](../cargo-operations/build-release.md) (or the project-equivalent build command)
