...
This skill MUST NOT invoke cargo, describe cargo invocations, or duplicate cargo command-line text. Cargo execution belongs entirely to [cargo-operations](../cargo-operations/SKILL.md). validate-build operates on the OUTPUTS of cargo-operations operations.
