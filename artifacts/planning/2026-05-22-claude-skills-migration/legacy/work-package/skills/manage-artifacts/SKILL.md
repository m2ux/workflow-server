...
- Use attached resource 01 (readme) for the README.md template and guidelines
...
**Description:** Verify the planning folder's README.md still matches the resource 01 template structure (header block, executive summary, problem/solution overview, progress table, links). Catches template drift that would otherwise only be flagged late in the workflow by a human reviewer.
...
- Read {planning_folder_path}/README.md and load resource 01 (the README template) via get_resource.
...
- **readme_missing** — Cause: No README.md found in planning_folder_path · Recovery: Re-run manage-artifacts::create-readme protocol to seed the README from resource 01 before continuing
...
- [readme](skill:legacy/work-package/resources/readme)
