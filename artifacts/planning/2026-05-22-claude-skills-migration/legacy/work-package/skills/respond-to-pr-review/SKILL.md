...
- Use attached resource 28 (pr-review-response) for full response guidance
...
- After applying reviewer-requested changes, run `gitnexus_detect_changes()` to inform the 'minor fix' vs 'significant change' classification — small symbol/process deltas suggest minor; broad fan-out suggests significant. See resource 27.
...
- [pr-review-response](skill:legacy/work-package/resources/pr-review-response)
