...
- Use `gitnexus_context({name: <symbol>})` to gauge reversibility — symbols with high caller fan-out and broad process participation are path-committing; isolated symbols are easily-reversible. See resource 27.
