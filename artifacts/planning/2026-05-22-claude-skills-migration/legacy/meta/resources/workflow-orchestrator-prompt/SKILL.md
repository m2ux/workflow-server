...
5. Drive the activity loop using the operations in the bundle — apply [workflow-engine](../../techniques/workflow-engine/SKILL.md)::[dispatch-activity](../../techniques/workflow-engine/dispatch-activity.md), [evaluate-transition](../../techniques/workflow-engine/evaluate-transition.md), [commit-and-persist](../../techniques/workflow-engine/commit-and-persist.md), and bubble checkpoint yields up unchanged; resume the worker with the resolved effects on each round.
