...
> [Design session] · `work-package` / `meta` · updated 2026-07-22
...
| F-4 | post-update-review | Binding-fidelity NEW drifts on tip (dead-output / verify-readme reads / entity_context) | Fixed on tip (`0195a44d`+); check passes 0 NEW | done |
