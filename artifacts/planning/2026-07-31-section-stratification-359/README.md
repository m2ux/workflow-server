...
PR2 for [#359](https://github.com/m2ux/workflow-server/issues/359): classify ~69 resource framings a section-scoped reader never receives, extend principle 30/32 and AP-134 with a sibling for framing outside any section, and fix three cross-section anchor dependencies. Delivery variant C is deferred until classify arithmetic supports it. Does not re-do the #358 citation tail (PR1 [#370](https://github.com/m2ux/workflow-server/pull/370)).
