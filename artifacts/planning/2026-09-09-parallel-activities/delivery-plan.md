...
- [ ] **The whole existing unit and end-to-end suite green with a frontier of length one.** Every ordinary session takes the identical path, and **no test is rewritten for behaviour** — only for the field name.
